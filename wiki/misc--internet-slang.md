...
## H264(x264)
The new(ish) video standard known as H.264/AVC presents a collection of state-of-the-art video coding capabilities that
can provide interoperable video broadcast or communication with degrees of capability that far surpass those of prior
standards such as Divx and Xvid, while maintaining a similar bitrate and filesize. MORE
